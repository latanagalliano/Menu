...
TESTI = [
    ...
    ("nota_allergeni", "Nota allergeni (in fondo alla pagina)", "Menù allergeni e informazioni sugli ingredienti disponibili su richiesta.", 7),
    ("nota_legenda_allergeni", "Nota nel popup della legenda allergeni", "Menù allergeni completo e informazioni sugli ingredienti disponibili su richiesta. Rif. Reg. UE 1169/2011.", 8),
]
